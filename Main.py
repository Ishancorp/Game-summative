    ...
    for ship_pointer in range(0, len(img)):
        ...
        if img[ship_pointer][3] == "T":
            try:
                ...
                angle = math.atan((x_enemy-img[ship_pointer][1]+(norm_enemy_ship.get_size()[0]/2))/(y_enemy-img[ship_pointer][2]-20+(norm_enemy_ship.get_size()[0]/2)))*180/3.14
