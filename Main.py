...
paused = font.render("Pause Game", True, black)
not_paused = font.render("Resume Game", False, black)
        ...
        if ev.type == QUIT:
            ...
            if 131 > x > 9 and 136 > y > 9:  # if the tank part of the menu is pressed
                ...
                if pause == True:  # if the game is already paused
                    ...
                    pause = True
                    print("Paused")
            elif pause == False and (
                        (y < 243 and x > 140) or (383 < y < 453 and x < 840) or (595 >= y > 525 and x > 140) or (
                    y > 595 and x > 840)):  # if the main gameplay part is pressed
                overlap = False
                for image in img:
                    if ((image[1] == x and image[2] == y)) or ((sprite_type == "M" and (
                                image[1] == x or image[1] == x - 35 or image[1] == x - 70) and image[2] == y)) or (
                            missile_pressed and (image[1] == x or image[1] == x + 35 or image[1] == x + 70) and image[
                        2] == y):  # if the
                        overlap = True
                        print("Overlap")
