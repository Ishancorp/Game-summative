        ...
        if ev.type == QUIT:  # if the game is quit
            ...
            if 131 > x > 9 and 136 > y > 9:  # if the tank part of the menu is pressed
                ...
                if pause:  # if the game is already paused
                    ...
                    pause = True
                    print("Paused")
            elif (not pause) and y > 175:  # if the main gameplay part is pressed
                overlap = False
                for image in img:
                ...
                if not overlap:
                    item = 0
                    if tank_pressed:
                        if money - tank_price < 0:
                            break
                        elif (210 < y < 385) or (440 < y < 550):
                            break
                        elif (-50 < x < 150) and (175 < y < 250):
                            break
                        elif (-50 < x < 150) and (525 < y < 640):
                            break
                        elif (-50 < x < 875) and (620 < y < 768):
                            break
                        elif (820 < x < 1024) and (300 < y < 525):
                            break
                        else:
                            item = ball
                            sprite_type = "T"
