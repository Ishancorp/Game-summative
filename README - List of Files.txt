...
11. The following music files are full background theme songs with the extension .mp3
    - "start_music.mp3":
        This file contains the theme music for the game. It is not played while the game has started.

------------------------------------------------------------------------------------------------------------

12. Program File: test_file.py

13. Text file for program: test_file.txt

------------------------------------------------------------------------------------------------------------

14. The following are text files with the extension .txt
    - "highscores.txt" (system file):
        This file contains the saved high-scores of the users.

    - "ReadMe - List of Files.py" (readme file):
